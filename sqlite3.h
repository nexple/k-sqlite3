...
**
*************************************************************************
** 이 헤더 파일 에는 인터페이스를 정의하고 그 SQLite 라이브러리와
** 클라이언트 프로그램 에 제시한다. 만약 C 함수 , 구조 , 데이터 형식 
** 과  정수의 정의는 이 파일 에 표시 되지 않습니다.
...
** 
**이 매크로는 컴파일러 마법의 다양한 종류를 해결하기 위해 사용
** 경고 메시지를 생성합니다. 
* /
